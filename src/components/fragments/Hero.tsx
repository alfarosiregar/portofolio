...
export default function Hero() {
  return (
    <section
      id="hero"
      className="min-h-screen relative overflow-hidden bg-gradient-to-br from-blue-700 via-blue-500 to-gray-650 to-blue-400 dark:from-gray-900 dark:via-blue-950 dark:to-black"
    >
      ...
      <div className="absolute inset-0 z-0 opacity-30">
        <div className="absolute inset-0 bg-gradient-to-br from-black via-gray-950 to-gray-900 dark:from-gray-900 dark:via-blue-950 dark:to-black animate-gradient-x"></div>
      </div>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          >
            ...
            <div className="flex justify-center lg:justify-start space-x-4 mb-8">
              <a
                href="https://github.com/alfarosiregar"
                target="_blank"
              ...
              <a
                href="https://linkedin.com/in/alfarosiregar/"
                target="_blank"
                rel="noopener noreferrer"
                className="p-3 rounded-full bg-white/80 hover:bg-white dark:bg-gray-800/80 dark:hover:bg-gray-800 transition-colors duration-300 shadow-lg hover:shadow-xl"
                aria-label="LinkedIn Profile"
              ...
              <a
                href="mailto:afdolfarosir19@gmail.com"
                className="p-3 rounded-full bg-white/80 hover:bg-white dark:bg-gray-800/80 dark:hover:bg-gray-800 transition-colors duration-300 shadow-lg hover:shadow-xl"
            ...
            <motion.button
              ...
              className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-full hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 shadow-lg hover:shadow-xl"
